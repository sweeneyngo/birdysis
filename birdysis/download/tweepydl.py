...
def download(filename):
    ...
    try:
        ...
        print("Missing API information. \
        Ensure an api_keys.json is created with the appropriate information.")
        sys.exit()
    ...
    with open(filename, mode="r", encoding="utf-8") as f:
        ...
        for i, t in enumerate(_id):
            try:
                status = api.get_status(
                    t, tweet_mode="extended", include_entities=True)._json
                ...
                for data_dict in entities:
                    ...
                    data_dict['tweet_url'] = \
                        f'https://twitter.com/statuses/{str(t)}'
        ...
        for row in data:
            if 'medium' in row:
                ...
                item_retrieve(row)
        print('Success. Check the "media" folder. Have a nice day!')
